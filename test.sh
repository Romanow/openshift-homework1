...
createNetworks() {
  ...
  docker network create -d bridge net-backend-"$BASE_LABEL"-"$STUDENT_LABEL" --label "$BASE_LABEL"-"$STUDENT_LABEL"
  docker network create -d bridge net-frontend-"$BASE_LABEL"-"$STUDENT_LABEL" --label "$BASE_LABEL"-"$STUDENT_LABEL"
}
